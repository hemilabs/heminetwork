...
var commands = map[protocol.Command]reflect.Type{
	...
	CmdBlockByHashRequest:                       reflect.TypeFor[BlockByHashRequest](),
	CmdBlockByHashResponse:                      reflect.TypeFor[BlockByHashResponse](),
	CmdBlockByHashRawRequest:                    reflect.TypeFor[BlockByHashRawRequest](),
	CmdBlockByHashRawResponse:                   reflect.TypeFor[BlockByHashRawResponse](),
	CmdBlockHeadersByHeightRawRequest:           reflect.TypeFor[BlockHeadersByHeightRawRequest](),
	CmdBlockHeadersByHeightRawResponse:          reflect.TypeFor[BlockHeadersByHeightRawResponse](),
	CmdBlockHeadersByHeightRequest:              reflect.TypeFor[BlockHeadersByHeightRequest](),
	CmdBlockHeadersByHeightResponse:             reflect.TypeFor[BlockHeadersByHeightResponse](),
	CmdBlockHeaderBestRawRequest:                reflect.TypeFor[BlockHeaderBestRawRequest](),
	...
	CmdBlockInsertRawResponse:                   reflect.TypeFor[BlockInsertRawResponse](),
	CmdBlockDownloadAsyncRequest:                reflect.TypeFor[BlockDownloadAsyncRequest](),
	CmdBlockDownloadAsyncResponse:               reflect.TypeFor[BlockDownloadAsyncResponse](),
	CmdBlockDownloadAsyncRawRequest:             reflect.TypeFor[BlockDownloadAsyncRawRequest](),
	CmdBlockDownloadAsyncRawResponse:            reflect.TypeFor[BlockDownloadAsyncRawResponse](),
	CmdBlocksByL2AbrevHashesRequest:             reflect.TypeFor[BlocksByL2AbrevHashesRequest](),
	CmdBlocksByL2AbrevHashesResponse:            reflect.TypeFor[BlocksByL2AbrevHashesResponse](),
	CmdKeystoneTxsByL2KeystoneAbrevHashRequest:  reflect.TypeFor[KeystoneTxsByL2KeystoneAbrevHashRequest](),
	CmdKeystoneTxsByL2KeystoneAbrevHashResponse: reflect.TypeFor[KeystoneTxsByL2KeystoneAbrevHashResponse](),
	CmdFeeEstimateRequest:                       reflect.TypeFor[FeeEstimateRequest](),
	...
	CmdZKValueAndScriptByOutpointResponse:       reflect.TypeFor[ZKValueAndScriptByOutpointResponse](),
	CmdZKBalanceByScriptHashRequest:             reflect.TypeFor[ZKBalanceByScriptHashRequest](),
	CmdZKBalanceByScriptHashResponse:            reflect.TypeFor[ZKBalanceByScriptHashResponse](),
	CmdZKSpentOutputsRequest:                    reflect.TypeFor[ZKSpentOutputsRequest](),
	CmdZKSpentOutputsResponse:                   reflect.TypeFor[ZKSpentOutputsResponse](),
	CmdZKSpendingOutpointsRequest:               reflect.TypeFor[ZKSpendingOutpointsRequest](),
