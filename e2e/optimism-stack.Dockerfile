...
ARG OP_GETH_COMMIT=bce106a0fb90538b1f02122ba69503a6edf0a537
ARG OPTIMISM_COMMIT=6ca664e638eefa537dac400305bd367b388b71ee
...
FROM golang:1.26.0-trixie@sha256:889885d7cc1275935e3f9920aabadc5fadbe873f633d92a746f1bc401dd40f69 AS foundry_build
ARG FOUNDRY_COMMIT
...
FROM golang:1.26.0-trixie@sha256:889885d7cc1275935e3f9920aabadc5fadbe873f633d92a746f1bc401dd40f69 AS just_build
...
FROM golang:1.26.0-trixie@sha256:889885d7cc1275935e3f9920aabadc5fadbe873f633d92a746f1bc401dd40f69 AS build_1
ARG OP_GETH_COMMIT
ARG OPTIMISM_COMMIT
ARG FOUNDRY_COMMIT
...
FROM golang:1.26.0-trixie@sha256:889885d7cc1275935e3f9920aabadc5fadbe873f633d92a746f1bc401dd40f69 AS build_2
ARG OP_GETH_COMMIT
ARG OPTIMISM_COMMIT
