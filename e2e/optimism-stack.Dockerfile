...
WORKDIR /git/op-geth
ARG OP_GETH_CACHE_BREAK=asdfsad
RUN git fetch origin
RUN git checkout aa4ec9270ec86ec09170318790ed88dabcc60e3e
...
RUN echo adslkfjasdfasdfasdf
RUN git fetch origin
RUN git checkout a14c3e09d87382912718c87d656869a1090714ac
