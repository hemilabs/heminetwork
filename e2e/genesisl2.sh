...
# deploy-l2oo.sh needs far more gas than the default 30M block gas limit
# allows.  geth-l1 must be run with a matching --miner.gaslimit, see
# docker-compose.yml.
echo "$(jq '.gasLimit = "0xbebc200"' /shared-dir/l1genesis.json)" > /shared-dir/l1genesis.json
