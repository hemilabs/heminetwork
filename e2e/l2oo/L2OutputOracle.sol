...
// (packages/contracts-bedrock/src/L1/L2OutputOracle.sol).  The contract was
// removed from later optimism releases; it is built against contracts-bedrock
// by e2e/deploy-l2oo.sh (the l2oo-deploy service in e2e/docker-compose.yml).
// The only change is the ISemver import path.
